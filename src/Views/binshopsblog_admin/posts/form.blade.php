    ...
    <div class='bg-white pt-4 px-4 pb-0 my-2 mb-4 rounded border'>
        ...
        @if($loop->iteration>1)
            ...
            @endif
                ...
                @if($post->has_image($size_info['basic_key']))
                    <a style="color: darkred" href="{{route("binshopsblog.admin.remove_photo", $post->slug)}}">Remove Image</a>
                @endif
            </div>
        @endforeach
...
<div class='bg-white pt-4 px-4 pb-0 my-2 mb-4 rounded border'>
    ...
    <div class='row'>
        ...
        @forelse(\BinshopsBlog\Models\BinshopsBlogCategory::orderBy("category_name","asc")->limit(1000)->get() as $category)
